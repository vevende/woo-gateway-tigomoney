...
class soap_transport_http extends nusoap_base {
	...
	* @access   private
	*/
	function connect($connection_timeout=0,$response_timeout=150){
...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=150, $cookies=NULL) {
	...
	* @deprecated
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=150, $cookies) {
